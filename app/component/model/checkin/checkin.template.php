...
<?php else: ?>
{
	...
	"locationLat": <?php echo is_null($values['checkin']->get('location_lat')) ? 'null' : urlencode($values['checkin']->get('location_lat')) ?>,
	"locationLon": <?php echo is_null($values['checkin']->get('location_lon')) ? 'null' : urlencode($values['checkin']->get('location_lon')) ?>,
	"idPhoto": <?php echo is_null($values['checkin']->get('id_photo')) ? 'null' : urlencode($values['checkin']->get('id_photo')) ?>,
